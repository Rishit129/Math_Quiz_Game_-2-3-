...
word = parseInt(number1)*parseInt(number2)
    ...
    answer = "<br> Answer: <input type='text' id = 'cake'>";
    check_button = "<br> <br> <button id='button_check' class ='btn btn-info' onclick='check()'> Check</button>";
...
answer_turn = "player2";
function check(){
    answer = document.getElementById("cake").value ;
